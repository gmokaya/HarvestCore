  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        <div className="relative flex flex-col h-full px-12 py-10">
          ...
          <div style={{ display: "inline-flex", flexDirection: "column", marginBottom: "4rem" }}>
            ...
            <span style={{ fontFamily: "'Josefin Sans', 'Futura', 'Century Gothic', sans-serif", fontSize: "9px", letterSpacing: "0.196em", color: "rgba(199,215,218,0.7)", textTransform: "uppercase", textAlign: "right", marginTop: "2px" }}>
              TRADE FINANCE
            </span>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 bg-white min-h-screen">
        {/* Mobile logo */}
        <div className="lg:hidden mb-8" style={{ display: "inline-flex", flexDirection: "column" }}>
          <span style={{ fontFamily: "'Belleza', serif", fontSize: "22px", lineHeight: 1.2, color: "#0A2A2A" }}>TokenHarvest</span>
          <span style={{ fontFamily: "'Josefin Sans', 'Futura', 'Century Gothic', sans-serif", fontSize: "8.5px", letterSpacing: "0.196em", color: "#0A2A2A", textTransform: "uppercase", opacity: 0.55, textAlign: "right", marginTop: "2px" }}>
            TRADE FINANCE
          </span>
        </div>
