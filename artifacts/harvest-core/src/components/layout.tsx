    ...
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside className="w-60 flex-shrink-0 hidden md:flex flex-col" style={{ backgroundColor: "#0A2A2A" }}>
        ...
        <div className="px-5 py-4 border-b border-white/10 flex items-baseline justify-between">
          ...
          <span style={{ fontFamily: "'Josefin Sans', 'Futura', 'Century Gothic', sans-serif", fontSize: "9px", letterSpacing: "0.196em", color: "rgba(199,215,218,0.65)", textTransform: "uppercase" }}>
            TRADE FINANCE
          </span>
        </div>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-14 flex-shrink-0 border-b border-border bg-background flex items-center justify-between px-6 sticky top-0 z-10">
          <div className="flex items-baseline gap-2 md:hidden">
            ...
            <span style={{ fontFamily: "'Josefin Sans', 'Futura', 'Century Gothic', sans-serif", fontSize: "7.5px", letterSpacing: "0.196em", textTransform: "uppercase", opacity: 0.5 }}>
              TRADE FINANCE
            </span>
          </div>
